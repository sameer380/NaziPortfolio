			...
			<Container fluid className="home-about-section" id="about">
				<Container>
					<Row>
						<Col md={8} className="home-about-description">
							<h1 style={{ fontSize: "2.6em" }}>
								LET ME <span className="yellow"> INTRODUCE </span> مايسلف
							</h1>
                  ...
                  > ,الهند </span>
								...
								<b className="yellow"> Java Full Stack, </b>
								as well as have knowledge in programming languages such as C,
								Java, Python data Analysis, R, Php and
								<b className="yellow"> Data Structures & Algoritms</b>
								<br />
								<br />I have a passion for working with{" "}
								<b className="yellow">Javascript</b> and
								<i>
									<b className="yellow">
										{" "}
